    ...
    <div className="flex min-h-screen bg-gray-50/50 dark:bg-gray-950">
      ...
      <aside className="fixed left-0 top-0 z-40 h-screen w-72 bg-white dark:bg-gray-900 border-r border-gray-200/50 dark:border-gray-800 shadow-xl">
        <ScrollArea className="h-full">
          ...
          <div className="p-6 border-b border-gray-200/50 dark:border-gray-800">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-purple-600 shadow-lg shadow-violet-500/30 group-hover:shadow-violet-500/50 transition-all">
          ...
          {/* User Profile Card */}
          <div className="p-4">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-600 via-purple-600 to-indigo-700 p-5 text-white">
              {/* Decorative Elements */}
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            <section id="profile" className="group">
              <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200/50 dark:border-gray-800 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden">
                ...
                <div className="relative h-32 bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 overflow-hidden">
                  ...
                  <div className="-mt-16 flex flex-col sm:flex-row sm:items-end gap-6 mb-6">
                    ...
                    <div className="flex-1 pt-4 sm:pb-2">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        ...
                        {isAdmin && (
                          <Badge className="w-fit bg-gradient-to-r from-amber-500 to-orange-500 text-white border-0 gap-1">
                            <Crown className="h-3 w-3" />
                            Admin
                          </Badge>
                        )}
            ...
            <section id="password">
              <div className="relative overflow-hidden bg-gradient-to-br from-rose-500/10 via-orange-500/10 to-amber-500/10 dark:from-rose-500/5 dark:via-orange-500/5 dark:to-amber-500/5 rounded-2xl border-2 border-rose-200/50 dark:border-rose-500/20 shadow-sm hover:shadow-xl transition-all duration-300 p-8">
                {/* Security Badge */}
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-rose-500 to-orange-600 shadow-lg shadow-rose-500/25">
